...
public class ProbationaryEmployee extends Employee {
    ...
    public BigDecimal computeGrossPay(BigDecimal hoursWorked) {
        // example rule: no clothing allowance for probationary
