...
public class ContractualEmployee extends Employee {
    ...
    public ContractualEmployee(
            String employeeID, String lastName, String firstName, LocalDate birthday,
            ...
            BigDecimal clothingAllowance, BigDecimal semiMonthlyRate, BigDecimal hourlyRate
    ) {
    ...
    public BigDecimal computeGrossPay(BigDecimal hoursWorked) {
        // Example rule: contractual gets hourly only (no allowances)
        return getHourlyRate().multiply(hoursWorked);
    }
